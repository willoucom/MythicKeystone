...
L["ABOUT_description"]    = "Every dungeon strategy and boss note, in-game and one click away."
L["ABOUT_mk_header"]      = "Check out MythicKeystone too"
L["ABOUT_mk_pitch"]       = "Your keys, your alts' keys, your party's keys and your guild's keys — all gathered in the LFG frame, in real time."
L["ABOUT_mk_feature_alts"]  = "• Alts — all your keystones at a glance"
L["ABOUT_mk_feature_party"] = "• Party — check the group's keys before entering"
L["ABOUT_mk_feature_guild"] = "• Guild — keys grouped by dungeon"
L["ABOUT_mk_feature_auto"]  = "• Auto Keystone — slots your key, with Ready Check &amp; Countdown"
L["ABOUT_mk_companion"]   = "A LibDataBroker companion is also available for Titan Panel and similar bars."
...
L["AA_trash3_mob3_name"]  = "Vicious Ravager"
...
L["SKY_trash3_desc1"]     = "%s: charge targeting the tank and 2 random players, leaves a 6s physical bleed — Bleed dispel (Evoker Naturalize) removes it. %s: tank buster — defensive."
