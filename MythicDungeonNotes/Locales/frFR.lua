...
L["ABOUT_description"]    = "Toutes les stratégies de donjon et notes de boss directement en jeu, accessibles en un clic."
L["ABOUT_mk_header"]      = "Découvrez aussi MythicKeystone"
L["ABOUT_mk_pitch"]       = "Vos clés, celles de vos alts, de votre groupe et de votre guilde — rassemblées dans la fenêtre LFG, en temps réel."
L["ABOUT_mk_feature_alts"]  = "• Alts — toutes vos clés en un coup d'œil"
L["ABOUT_mk_feature_party"] = "• Groupe — vérifiez les clés avant d'entrer"
L["ABOUT_mk_feature_guild"] = "• Guilde — clés regroupées par donjon"
L["ABOUT_mk_feature_auto"]  = "• Auto Keystone — place votre clé, avec Ready Check &amp; Compte à rebours"
L["ABOUT_mk_companion"]   = "Un compagnon broker (LibDataBroker) est aussi disponible pour Titan Panel et barres similaires."
...
L["AA_entrance_intro"]    = "Académie d'Algeth'ar — Héritage Dragonflight, Îles aux Dragons."
L["AA_entrance_bosses"]   = "4 bosses : Ancien embroussaillé -> Tricérabec -> Vexamus -> Écho de Doragosa."
L["AA_entrance_desc"]     = "Chaque professeur vous octroie un buff selon son vol draconique."
...
L["AA_trash3_mob1_name"]  = "Manafiel corrompu"
L["AA_trash3_mob2_name"]  = "Hache d'armes envoûtée"
L["AA_trash3_mob3_name"]  = "Ravageur vicieux"
L["AA_trash3_mob4_name"]  = "Fourrageur des arcanes"
L["AA_trash3_mob5_name"]  = "Manuel turbulent"
L["AA_trash4_mob1_name"]  = "Echo-chevalière d'Algeth'ar"
L["AA_trash4_mob2_name"]  = "Invocatrice spectrale"
...
L["AA_trash2_mob2_desc1"] = "• %s — Frontal dirigé vers une cible aléatoire, à éviter (risque de chute)."
...
L["SOT_intro_desc2"]      = "4 bosses : Zuraal le Zélateur -> Saprish -> Vice-roi Nezhar -> L'ura."
-- Trash notable
L["SOT_trash1_name"]      = "Subjugatrice sans pitié"
...
L["SOT_trash2_name"]      = "Adjuratrice sombre"
...
L["SOT_trash4_name"]      = "Championne ombre-garde"
...
L["SKY_intro_desc2"]      = "4 bosses : Ranjit -> Araknath -> Rukhran -> Grand sage Viryx."
-- Trash notable
L["SKY_trash1_name"]      = "Maître des chakrams jaillissant"
...
L["SKY_trash3_name"]      = "Trancheserre décoré"
L["SKY_trash3_desc1"]     = "%s : charge ciblant le tank et 2 joueurs aléatoires, laisse un saignement physique 6s — un dispel saignement (Évocateur Naturalisation) le retire. %s : tank buster — défensif."
L["SKY_trash4_name"]      = "Mande-trombe conducteur"
...
L["SKY_trash6_name"]      = "Corbeau de l'effroi"
...
L["SKY_boss4_name"]       = "Grand sage Viryx"
...
L["POS_intro_desc2"]      = "3 bosses : Maître-forge Gargivre -> Ick &amp; Krick -> Seigneur du Fléau Tyrannus."
L["POS_intro_desc3"]      = "Un gauntlet de Frostsworn Generals précède le troisième boss."
-- Trash notable
L["POS_trash1_name"]      = "Liche pulseffroi"
...
L["POS_trash2_name"]      = "Nécrolyte Murmemort"
...
L["POS_trash7_name"]      = "Tourmenteur de proie & Massacreur irossement"
...
L["POS_boss1_name"]       = "Maître-forge Gargivre"
...
L["POS_boss3_name"]       = "Seigneur du Fléau Tyrannus"
...
L["MT_intro_desc2"]       = "4 bosses : Assemblage arcanique de dispersion des foules -> Séranel Cinglesoleil -> Gémellus -> Dégentrius."
...
L["MT_boss2"]             = "Séranel Cinglesoleil"
L["MT_boss3"]             = "Gémellus"
L["MT_boss4"]             = "Dégentrius"
-- Noms des mobs du trash
L["MT_trash_arcane_sentry_name"]      = "Sentinelle des arcanes"
L["MT_trash_arcane_magister_name"]    = "Magistrice des arcanes"
L["MT_trash_sunblade_name"]           = "Brute lamesoleil"
L["MT_trash_lightward_name"]          = "Soigneur parelumière"
L["MT_trash_codex_name"]              = "Codex animé"
L["MT_trash_pyromancer_name"]         = "Pyromancienne flamboyante"
L["MT_trash_familiar_name"]           = "Familier tresse-sorts"
L["MT_trash_wyrm_name"]               = "Wyrm brillécaille"
L["MT_trash_spellbreaker_name"]       = "Brise-sort runique"
L["MT_trash_voidling_name"]           = "Engeance du Vide"
L["MT_trash_shredder_name"]           = "Déchiqueteur âme-creuse"
L["MT_trash_voidwalker_name"]         = "Marcheur du Vide effroyable"
L["MT_trash_voidcaller_name"]         = "Implorateur du Vide ombre-faille"
L["MT_trash_unstable_name"]           = "Engeance du Vide instable"
L["MT_trash_void_infuser_name"]       = "Terreur du Vide"
L["MT_trash_tyrant_name"]             = "Tyran dévorant"
...
L["MT_trash_pyromancer_note"]         = "Après la Pyromancer, la porte de la bibliothèque s'ouvre et les bibliothécaires disparaissent. Dans la cour suivante, des |cffFFD700Energy Crystals|r sont dispersés : interagir avec eux pour les drainer et obtenir un bonus temporaire de dégâts et de soins."
...
L["MC_intro_desc2"]       = "3 bosses : Muro'jin &amp; Nekraxx -> Vordaza -> Rak'tul (Réceptacle des âmes)."
-- Noms du trash
L["MC_trash_berserker_name"]   = "Berserker en frénésie & Chasseuse de têtes enthousiaste"
L["MC_trash_juggernaut_name"]  = "Mastodonte mastoc"
L["MC_trash_hexxer_name"]      = "Maléficieur ritualiste"
L["MC_trash_guardian_name"]    = "Garde-maléfices"
L["MC_trash_skirmisher_name"]  = "Tirailleur sinistre"
L["MC_trash_soulrender_name"]  = "Déchiqueteur d'âmes creux"
L["MC_trash_defender_name"]    = "Défenseur lié"
L["MC_trash_shade_name"]       = "Ombre tourmentée"
-- Descriptions trash
...
L["MC_trash_shade_desc1"]      = "%s : cast de 2,5s appliquant un DoT ombre cumulable (impact initial + tick 8s) — interrompre si possible. Les soigneurs ne dispel pas le premier stack ; attendre que le joueur accumule plusieurs stacks avant de dispel pour économiser les GCDs."
...
L["MC_boss3_name"]             = "Rak'tul, Réceptacle des âmes"
...
L["NPX_intro_desc2"]      = "3 bosses : Chef forge-cœur Kasreth -> Garde-cœur Nysarra -> Lothraxion."
-- Noms du trash
L["NPX_trash_arcanist_name"]   = "Arcaniste forge-cœur"
L["NPX_trash_engineer_name"]   = "Ingénieur en flux"
L["NPX_trash_seer_name"]       = "Voyant du circuit"
L["NPX_trash_scrounger_name"]  = "Écornifleur âme-creuse"
L["NPX_trash_nullifier_name"]  = "Grand annulateur"
L["NPX_trash_dreadflail_name"] = "Fléau-d'effroi"
L["NPX_trash_lightwrought_name"] = "Lumière-forgé"
L["NPX_trash_voidcaller_name"] = "Implorateur du Vide maudit"
-- Descriptions trash
...
L["NPX_boss1_name"]            = "Chef forge-cœur Kasreth"
...
L["NPX_boss2_name"]            = "Garde-cœur Nysarra"
...
L["WRS_intro_desc2"]      = "4 bosses : Aube-de-Braise -> Duo abandonné (Kalis et Clenche) -> Commandant Kroluk -> Le Cœur fébrile."
-- Noms du trash
L["WRS_trash_magus_name"]       = "Magus paresort"
L["WRS_trash_steward_name"]     = "Régisseuse fébrile"
L["WRS_trash_woebringer_name"]  = "Porte-malheur dévouée"
L["WRS_trash_behemoth_name"]    = "Béhémoth de chair"
L["WRS_trash_mystic_name"]      = "Mystique fantasmatique"
-- Descriptions trash
