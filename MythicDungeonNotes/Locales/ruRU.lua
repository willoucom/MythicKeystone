...
-- Notable Trash
L["DN_trash_label"]       = "Важный треш"
L["DN_trash_todo"]        = "В БУДУЩЕМ: перечислить важный треш Амани (Наездники на зверях, Посвящённые Лоа Мороза, патрулирующие ветрокрылы) и их ключевые способности."
